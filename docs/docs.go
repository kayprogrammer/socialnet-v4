...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "schemas.GroupChatInputResponseDataSchema": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string",
        ...
        "schemas.GroupChatInputResponseSchema": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/schemas.GroupChatInputResponseDataSchema"
                },
                "message": {
                    "type": "string",
                    "example": "Data fetched/created/updated/deleted"
        ...
        "schemas.MessagesResponseDataSchema": {
            ...
            "properties": {
                ...
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/schemas.MessageSchema"
                    }
                },
                "last_page": {
                    "type": "integer",
